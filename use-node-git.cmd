...
if exist ".nvmrc" (
    ...
    :: No .nvmrc file found. This could mean that we don't need node here, lets continue using git...
    goto continueGit
)
...
:nodeNotInstalled
echo [ERROR] NODE v%VERSION% NOT INSTALLED! You can solve this executing 'use-node' once to install the requested version!
exit /b 1
